...
<div id="carouselExampleIndicators" class="carousel slide " data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100 mobile_carousel" src="{{asset("images/carousel/img1_carousel.jpg")}}" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100 mobile_carousel" src="https://images.unsplash.com/photo-1529408632839-a54952c491e5?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=1100&ixid=eyJhcHBfaWQiOjF9&ixlib=rb-1.2.1&q=80&w=1920" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100 mobile_carousel" src="{{asset("images/carousel/img3_carousel.jpg")}}" alt="Third slide">
    </div>
  </div>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-12 mt-2 p-3 ">
      <div class="d-flex justify-content-center flex-column align-items-center myBg">
      ...
      <button class="mt-5 mb-5 p-2 pl-5 pr-5 btn"><span><a href="{{route('apartment.plus')}}"> Scopri gli Alloggi</a></span>  <i class="fas fa-angle-right"></i></button>
      </div>
    </div>
