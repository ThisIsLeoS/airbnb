                            ...
                            <li class="nav-item">
                              <a class="nav-link" href="{{ route('apartmentUserMessage.show', Auth::user() -> id) }}"><i class="fas fa-envelope"><sup>
                                ...
                                @foreach (Auth::user() -> apartments as $apartment)
                                    @php($sum += count($apartment -> messages))
                                 @endforeach {{$sum}}</sup></i></a>
                                </li>
