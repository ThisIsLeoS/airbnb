...
function init(){
  ...
  $("#mySearch button").click(function(event) {
    ...
    $.ajax({
      ...
      "data": {
        "key": "PkKS2dAj8BrmI6ki7jkQEXlEbn5AkjKp",
        "limit": "10", // opzione per farsi restituire solo 1 risultato
      ...
      "success": function (data) {
        // throw(data);
        console.log(data);
        // TODO: da fare con while invece di for
        ...
        $("#mySearch")
          // al form vengono aggiunti i campi contenenti longitudine e latitudine
          .append(
            "<input type='hidden' name='lat' value='" + res.position.lat + "'/>",
            "<input type='hidden' name='lon' value='" + res.position.lon + "'/>"
          )
          // il form viene sottomesso
          .submit();
      },
